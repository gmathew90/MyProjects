...
MySQLDataStoreUtilities MS= new MySQLDataStoreUtilities();
            ResultSet rs = MS.Product("SmartPhones");
            while(rs.next()) {
out.println("            <tr><td>");
...
out.println("         	   	<li >Price: "+rs.getString("price")+"</li>");
...
out.println("                    <input name=\"type\" id=\"type\" value="+"Smartphones"+" type=\"hidden\" /></p>");
...
if (type.equals("StoreManager"))
{
out.println("                <form name=\""+rs.getString("id")+"\" method=\"POST\" action=\"/csj/ProdDelete\">");
out.println("                    <input name=\"id\" id=\"id\" value="+rs.getString("id")+" type=\"hidden\" /></p>");
out.println("                    <input name=\"type\" id=\"type\" value="+"Smartphones"+" type=\"hidden\" /></p>");
out.println("                    <p><input name=\"send\" style=\"margin-left: 150px;\" class=\"formbutton\" value=\"Delete\" type=\"submit\" /></p>");
out.println("                </form>");
}
out.println("            </td></tr>");
}
