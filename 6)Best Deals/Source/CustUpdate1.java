...
public class CustUpdate1 extends HttpServlet
 {
...
out.println("<tr><td>");
out.println("            <h5>"+"ID"+"</td><td>    "+""+"</h5></td></tr>");
try{

  MySQLDataStoreUtilities MS=new MySQLDataStoreUtilities();

ResultSet rs = MS.CustUpdate1();
out.println("Query Excecuted");
while(rs.next()) {
username=rs.getString("username");
 out.println("<tr>");
     		if (1==1){
out.println("                <form name=\"Login\" method=\"POST\" action=\"/csj/CustDelete\">");

out.println("            <h5><td>"+username+"</td><td>"+""+"</td></h5>");
out.println("                    <td><input name=\"id\" id=\"id\" value="+username+" type=\"hidden\" /></td></p>");
