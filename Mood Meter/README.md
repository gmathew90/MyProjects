...
Conclusions and Future Work Thus it can be concluded that the mood of a region is indeed reflected in the tweets made from a region and this mood can be monitored from the tweets. And it can also be concluded that Mondays are usually the most depressing day of a week and holidays increase the happiness of the people.
